...
//>>
public class CreatedFormAnalysisPieChart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_created_form_analysis_pie_chart);
    ...
    String btnttxts[]={
            "Show Bars","Download Pdf","Choose Background Color"
    };
        ...
        for (int i = 0; i < bmb.getPiecePlaceEnum().pieceNumber(); i++) {
            ...
            builder.listener(new OnBMClickListener() {
                ...
                public void onBoomButtonClick(int index) {
                    ...
                    if(index == 0 )
                    {
                        Intent i =  new Intent(CreatedFormAnalysisPieChart.this, CreatedFormAnalysisBarChart.class);
...
//cv.setClipToPadding(false);
    ...
    public void ananlyseallcourse(String event)
    {
        ...
        f.collection("DYNFORMREZ/"+formname+"/EVENTNAME/"+event+"/COUNTS" ).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for(DocumentSnapshot questionno : queryDocumentSnapshots.getDocuments())
                {
                    ...
                    f.document("DYNFORMS/"+formname+"/QUESTIONS/"+questionno.getId()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        @Override
...
*/
    ...
    {
        View u = ((Activity) CreatedFormAnalysisPieChart.this).findViewById(R.id.scroll);

        ScrollView z = (ScrollView) ((Activity) CreatedFormAnalysisPieChart.this).findViewById(R.id.scroll);
        ...
        String fileName = "SakshiPie"+event+".jpg";
...
//>>
    ...
    public void pickcolor() {
        ...
        final ColorPicker cp = new ColorPicker(CreatedFormAnalysisPieChart.this,r,g,b);
        cp.show();
