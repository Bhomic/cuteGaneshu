...
public class SelectedFormShow extends AppCompatActivity {
...
dynevent =  ""+this.getIntent().getExtras().getString("dynevent");
    ...
    public void addquestions()
    {
        ...
        ff.collection("DYNFORMS").document(dynevent).collection("QUESTIONS").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        ff.collection("DYNEVE/"+evname+"/COURSES/"+course+"/USERS").document(""+emailid).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                ...
                                if(documentSnapshot!=  null && documentSnapshot.exists()) {
                                    ...
                                    Intent i =  new Intent(SelectedFormShow.this ,thankyou.class);
                                    startActivity(i);
...
*/
    ...
    public void submit()
    {
        if(!evname.equals("")) {
            ...
            ff.collection("FORMNAME/"+dynevent+"/event").document("" + evname).collection("COURSES").document(course).collection("USERS").document("" + emailid).collection("RESPONSES").document("RADIO")
                    .set(rbvals).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    tost("F " + rbvals + " send! ");
            ...
            ff.collection("FORMNAME/"+dynevent+"/event").document("" + evname).collection("COURSES").document(course).collection("USERS").document("" + emailid).collection("RESPONSES").document("EDITTEXT")
                    .set(etvals).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    tost("F " + etvals + " send! ");
            ...
            Map<String, Object> dummy = new HashMap<>();
            dummy.put("STK", "m");
            ff.collection("FORMNAME/"+dynevent+"/event").document("" + evname).set(dummy);
            ff.collection("FORMNAME/"+dynevent+"/event").document("" + evname).collection("COURSES").document(course).set(dummy);
            ff.collection("FORMNAME/"+dynevent+"/event").document("" + evname).collection("COURSES").document(course).collection("USERS").document("" + emailid).set(dummy);
            ff.collection("FORMNAME").document(dynevent).set(dummy);
        }
        else
        {
