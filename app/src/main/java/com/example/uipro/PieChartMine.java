...
//>>
public class PieChartMine extends AppCompatActivity {
        ...
        for (int i = 0; i < bmb.getPiecePlaceEnum().pieceNumber(); i++) {
            ...
            builder.listener(new OnBMClickListener() {
                ...
                public void onBoomButtonClick(int index) {
                    ...
                    if(index == 0 )
                    {
                        Intent i =  new Intent(PieChartMine.this, BarChartMine.class);
...
//>>???
    ...
    {
        View u = ((Activity) PieChartMine.this).findViewById(R.id.scroll);

        ScrollView z = (ScrollView) ((Activity) PieChartMine.this).findViewById(R.id.scroll);
...
//>>???
    ...
    public void pickcolor() {
        ...
        final ColorPicker cp = new ColorPicker(PieChartMine.this,r,g,b);
        cp.show();
