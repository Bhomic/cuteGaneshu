...
//choosing events to generate analysis
//>>

public class IQSEAnalysis extends AppCompatActivity {
  ...
  FirebaseFirestore ff;
    ...
    {
        Toast.makeText(IQSEAnalysis.this, ""+msg, Toast.LENGTH_SHORT).show();
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_iqseanalysis);
        ...
        for( DocumentSnapshot d :  queryDocumentSnapshots.getDocuments())
        {
            ...
            b.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i =  new Intent(getApplicationContext(),PieChartMine.class);
